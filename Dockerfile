...
RUN wget -O /workspace/repositories/Fooocus/models/checkpoints/cyberrealisticXL_v22.safetensors https://huggingface.co/ProjectGasm/mod3l-hub/resolve/main/M0D3LS/cyberrealisticXL_v22.safetensors?download=true
RUN wget -O /workspace/repositories/Fooocus/models/checkpoints/dreamshaperXL_v21TurboDPMSDE.safetensors https://huggingface.co/ProjectGasm/mod3l-hub/resolve/main/M0D3LS/dreamshaperXL_v21TurboDPMSDE.safetensors?download=true
RUN wget -O /workspace/repositories/Fooocus/models/checkpoints/lustifySDXLNSFWSFW_v20.safetensors https://huggingface.co/ProjectGasm/mod3l-hub/blob/main/M0D3LS/lustifySDXLNSFWSFW_v20.safetensors?download=true
RUN wget -O /workspace/repositories/Fooocus/models/checkpoints/ponyDiffusionV6XL.safetensors https://huggingface.co/ProjectGasm/mod3l-hub/blob/main/M0D3LS/ponyDiffusionV6XL.safetensors?download=true
RUN wget -O /workspace/repositories/Fooocus/models/checkpoints/realvisxlV40_v40LightningBakedvae.safetensors https://huggingface.co/ProjectGasm/mod3l-hub/blob/main/M0D3LS/realvisxlV40_v40LightningBakedvae.safetensors?download=true

#CONTROLNETS
RUN wget -O /workspace/repositories/Fooocus/models/controlnet/promax.safetensors https://huggingface.co/ProjectGasm/mod3l-hub/blob/main/CONTROL-NET/promax.safetensors?download=true

#LORAS

RUN wget -O /workspace/repositories/Fooocus/models/loras/bl0wj0b.safetensors https://huggingface.co/ProjectGasm/mod3l-hub/resolve/main/L0RAS/bl0wj0b.safetensors?download=true
RUN wget -O /workspace/repositories/Fooocus/models/loras/st3phl0v3-selfie.safetensors https://huggingface.co/ProjectGasm/mod3l-hub/blob/main/L0RAS/st3phl0v3-selfie.safetensors?download=true
RUN wget -O /workspace/repositories/Fooocus/models/loras/b00bs.safetensors https://huggingface.co/ProjectGasm/mod3l-hub/blob/main/L0RAS/b00bs.safetensors?download=true

RUN wget -O /workspace/repositories/Fooocus/models/loras/SDXL-ClaymationX-Lora.safetensors https://huggingface.co/ProjectGasm/mod3l-hub/blob/main/L0RAS/SDXL-ClaymationX-Lora.safetensors?download=true
RUN wget -O /workspace/repositories/Fooocus/models/loras/wet_tshirt.safetensors https://huggingface.co/ProjectGasm/mod3l-hub/blob/main/L0RAS/wet_tshirt.safetensors?download=true
RUN wget -O /workspace/repositories/Fooocus/models/loras/underboob.safetensors https://huggingface.co/ProjectGasm/mod3l-hub/blob/main/L0RAS/underboob.safetensors?download=true

RUN wget -O /workspace/repositories/Fooocus/models/loras/dramatic_lighting_pony.safetensor https://huggingface.co/ProjectGasm/mod3l-hub/resolve/main/L0RAS/dramatic_lighting_pony.safetensors?download=true
